                      ...
                      Container(
                        ...
                        decoration: const BoxDecoration(
                            image: DecorationImage(
                                fit: BoxFit.cover, image: AssetImage("assets/images/teacher.png"))),
                      ),
                      const SizedBox(
                        width: 15,
                      ),
                        ...
                        child: Column(
                          ...
                          children: [
                            const Text(
                              ...
                              style: TextStyle(
                                  fontSize: 18, fontWeight: FontWeight.bold, color: ColorsAsset.kTextcolor),
                            ),
                            const Text(
                              "Enrolled",
                              style: TextStyle(
                                  fontSize: 16, fontWeight: FontWeight.bold, color: ColorsAsset.kPrimary),
                            ),
                            const SizedBox(
                              height: 15,
                            ),
